...
namespace MyProject.Web.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(IAdminAppService adminAppservice)
        {
        ...
        public ActionResult ImgCode()
        {
            ...
            MemoryStream ms = getImageValidate(str);
        ...
        //生成图像
        private MemoryStream getImageValidate(string strValue)
        {
